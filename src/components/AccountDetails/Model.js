...
const Modal = ({ showModal, closeModal }) => {
    ...
    return (
        <div
            className={` fixed  inset-0 z-50 flex items-center px-[80px] py-[60px] justify-center ${showModal ? 'invisible md:visible' : 'invisible'
                }`}
        >
            ...
            <div className="bg-white p-6  rounded-lg shadow-lg z-10">
                ...
                <div
                    ...
                    className="flex mb-[240px] relative sm:mb-[150px] md:mb-0 flex-col lg:flex-row items-start md:items-center justify-between h-auto lg:h-[472px] mt-10 lg:mt-0"
                >
                    <button
                      ...
                      show salon hours
                        ...
                        <div className="mt-2">
                            ...
                            <button
                                ...
                                className="btn-primary w-full   sm:w-[250px] xl:w-[273px] h-[48px] mt-6 mb-6 lg:mb-0 rounded-[4px]"
                                style={{
