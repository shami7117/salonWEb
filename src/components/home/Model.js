  ...
  return (
    ...
    >
      <div className="bg-white px-4 py-6 overflow-y-scroll md:overflow-y-hidden pb-4  h-full lg:h-[472px] rounded-lg shadow-lg  z-10">
        <div className="flex md:mb-[240px] relative sm:mb-[150px] md:mb-0 flex-col lg:flex-row items-start md:items-center justify-between h-full lg:h-[472px] lg:mt-0">
          <button
