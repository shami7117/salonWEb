  ...
  return (
    <div className="bg-[url(/images/Video.png)] bg-[#F3F3F3] bg-left h-[90vh] md:h-[85vh] py-8  bg-contain bg-no-repeat bg-center md:bg-[url(/images/Video.png)] lg:bg-[url(/images/Video.png)]  flex items-between justify-between">
      ...
      >
        ...
        <div className={`${styles.discover} flex flex-col items-center justify-center`} style={{ backgroundColor: '#FCFCFC' }}>
          ...
          <RevealWrapper
            ...
            viewOffset={{ top: 0, right: 0, bottom: 0, left: 0 }}
          >
            <center className="text-[#808285]">
              <p className={styles.verification}>We send a verification code to your email!</p>
            </center>
            <div>
              <center className="mt-12">
                <div>
                  <input
                    ...
                    className="w-[305px] sm:w-[359px] h-[50px] bg-white pl-4 border-2 border-solid border-blue-300 rounded-md mb-4"
                  />
